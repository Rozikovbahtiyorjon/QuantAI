...
print(f'Cross-sectional: ret={result["stats"]["total_ret_pct"]:.1f}% DD={result["stats"]["maxdd_pct"]:.1f}% PF={result["stats"]["pf"]:.2f} Sharpe={result["stats"]["sharpe"]:.2f} trades={result["stats"]["trades"]}')